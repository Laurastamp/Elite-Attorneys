...
!function() {
    ...
    var D = Object.freeze({
      ...
      , j = null;
    function A(t, e) {
        hi() && t && e && "string" == typeof t && "string" == typeof e && t.length < 255 && e.length < 255 && (j = {
            key: t,
            value: e
        },
        vr(24))
    ...
    function F() {
        ...
        vr(25),
        L.gap < 3e5 ? B = Y(F, U) : li && (A("clarity", "suspend"),
        _i(),
    ...
    function Et(t, e, n) {
        ...
        kt.indexOf(wt.checksum) < 0 && (kt.push(wt.checksum),
        Ja(41)))
    }
    ...
    function Ft(t) {
        ...
        if (t.nodeType === Node.ELEMENT_NODE && "IFRAME" === t.tagName) {
            var n = t;
            try {
                n.contentDocument && (qt.set(n.contentDocument, n),
                e = !0)
            } catch (t) {}
        }
        return e
    ...
    function re(t, e, n, a) {
        ...
        void 0 === a && (a = !1);
        var r = It.indexOf(t);
        r >= 0 && 1 === e && a ? (It.splice(r, 1),
        It.push(t)) : -1 === r && n && It.push(t)
    }
    var ie = Object.freeze({
        __proto__: null,
        add: function(t, e, n, a) {
            var r, i = Vt(t, !0), u = e ? Vt(e) : null, c = ae(t), s = null, l = Fe(t) ? i : null, d = Yt.has(t) ? Yt.get(t) : null, f = o.content ? 1 : 3;
            u >= 0 && _t[u] && ((s = _t[u]).children.push(i),
            l = null === l ? s.region : l,
            d = null === d ? s.metadata.fraud : d,
            f = s.metadata.privacy),
            n.attributes && "data-clarity-region"in n.attributes && (Ve(t, n.attributes["data-clarity-region"]),
            l = i),
            Tt[i] = t,
            _t[i] = {
                id: i,
            ...
            Zt(_t[i]),
            "IMG" === (r = _t[i]).data.tag && 3 === r.metadata.privacy && (r.metadata.size = []),
            re(i, a)
        },
        get: $t,
        getId: Vt,
    ...
    function pe() {
        ...
        t.task().then((function() {
            ...
            t.id === Ar() && (e && Ka(0, 1, e.name, e.message, e.stack),
            se = null,
            pe())
        }
        )))
        ...
        Animation.prototype[e] = function() {
            if (hi()) {
                if (!this[Ie]) {
                    ...
                    Ae(s(), this[Ie], 0, JSON.stringify(n), JSON.stringify(a), Vt(this.effect.target))
                }
                if (this[Ce]++ < De) {
                    var r = null;
                    switch (e) {
        ...
        at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(j) {
                ...
                case 4:
                    ...
                    j.label = 5;
                case 5:
                    return v < g.length ? (b = g[v],
                    0 !== (y = ve(e)) ? [3, 7] : [4, be(e)]) : [3, 9];
                case 6:
                    y = j.sent(),
                    j.label = 7;
                case 7:
                    ...
                    x = 0,
                    M = k ? ["tag", "attributes", "value"] : ["tag"]; x < M.length; x++)
                        if (w[N = M[x]])
                            switch (N) {
                            case "tag":
                                I = Re(b),
                                ...
                                r.push(E ? "*M" : w[N]),
                                I && 2 === I.length && r.push("".concat("#").concat(He(I[0]), ".").concat(He(I[1])));
                                break;
                            case "attributes":
                                for (D in w[N])
    ...
    var We = []
      ...
      , Be = null;
    function Ve(t, e) {
        !1 === Ye.has(t) && (Ye.set(t, e),
        (Be = null === Be && Ue ? new IntersectionObserver(Ge,{
            threshold: [0, .2, .4, .6, .8, 1]
        }) : Be) && t && t.nodeType === Node.ELEMENT_NODE && Be.observe(t))
    }
    function Fe(t) {
        return Ye && Ye.has(t)
    }
    function Je() {
        for (var t = [], e = 0, n = Pe; e < n.length; e++) {
            var a = n[e]
              , r = Vt(a.node);
            r in Xe || (r ? (a.data.id = r,
            Xe[r] = a.data,
            We.push(Ke(a.data))) : t.push(a))
        }
        Pe = t,
        We.length > 0 && ze(7)
    }
    ...
    function Ze(t, e, n, a) {
        ...
        e.id ? (e.id in Xe && r || !(e.id in Xe)) && (Xe[e.id] = e,
        We.push(Ke(e))) : Pe.push({
            node: t,
            data: e
        })
    }
    ...
    function Rn(t) {
        ...
        if (null !== e && !(null === e.anchorNode && null === e.focusNode || e.anchorNode === e.focusNode && e.anchorOffset === e.focusOffset)) {
            ...
            null !== Ln && null !== An.start && n !== e.anchorNode && (X(zn),
            Hn(21)),
            An = {
                start: e.anchorNode,
    ...
    function Gn(t) {
        ...
        t.nodeType === Node.DOCUMENT_NODE && (on(t),
        function(t) {
        ...
        for (var e = 0, n = Object.keys(t); e < n.length; e++) {
            ...
            if ("@type" === a && "string" == typeof r)
                ...
                case "aggregaterating":
                    t.ratingValue && (W(11, $n(t.ratingValue, 100)),
                    W(18, $n(t.bestRating)),
    ...
    var ta = ["title", "alt", "onload", "onfocus", "onerror", "data-drupal-form-submit-last"]
      , ea = /[\r\n]+/g;
    function na(t, e) {
        var n, a = null;
        if (2 === e && !1 === ee(t))
        ...
        case Node.DOCUMENT_FRAGMENT_NODE:
            ...
            if (s.host)
                if (Bt(s),
                "function" === typeof s.constructor && s.constructor.toString().indexOf("[native code]") >= 0) {
                    aa(s);
        ...
        case Node.ELEMENT_NODE:
            ...
            switch (i = t.parentElement ? t.parentElement : t.parentNode ? t.parentNode : null,
            ...
            case "BASE":
                ...
                if (O) {
                    ...
                    S.href = m.href,
                    O.data.attributes["*B"] = S.protocol + "//" + S.host + S.pathname
                }
                break;
            case "STYLE":
                var x = {
            ...
            case "IFRAME":
                ...
                Ft(M) && (!function(t) {
                    !1 === ee(t) && ti(t, "load", ka.bind(this, t, "childList"), !0)
                }(M),
                N.attributes["*O"] = "true",
                M.contentDocument && M.contentWindow && "loading" !== M.contentDocument.readyState && (a = M.contentDocument)),
                ie[r](t, i, N, e);
                break;
            default:
                var T = {
    ...
    function ra(t) {
        ...
        return (0 === e.length || n > 0) && (e = ia(t.sheet)),
        e
    }
    function ia(t) {
        var e = ""
        ...
        return at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(c) {
                ...
                case 2:
                    ...
                    c.label = 3;
                case 3:
                    return 2 === o ? [3, 4] : ((u = na(r, n)) && a.push(u),
                    [3, 1]);
                case 4:
                    return [2]
                }
        ...
        return at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(d) {
                ...
                case 4:
                    ...
                    c = function(t, e, n) {
                        ...
                        if (a && "HTML" !== a.data.tag) {
                            var r = s() > pa
                              ...
                              , u = [a.selector ? a.selector.join() : "", o, t.attributeName, ba(t.addedNodes), ba(t.removedNodes)].join();
                            va[u] = u in va ? va[u] : [0, n];
                            var c = va[u];
                            if (!1 === r && c[0] >= 10 && ya(c[2], 2, e),
                            c[0] = r ? c[1] === n ? c[0] : c[0] + 1 : 1,
                            c[1] = n,
                            10 === c[0])
                                return c[2] = t.removedNodes,
                                "suspend";
                            if (c[0] > 10)
                                return ""
                        }
                    ...
                    c && u && u.nodeType == Node.DOCUMENT_FRAGMENT_NODE && u.host && Bt(u),
                    c) {
                    case "attributes":
                        na(u, 3);
                        break;
    ...
    function wa(t) {
        return fa.indexOf(t) < 0 && fa.push(t),
        ha && X(ha),
        ha = Y((function() {
            !function() {
        ...
        at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(H) {
                ...
                case 20:
                    ...
                    i = kn; r < i.length; r++)
                        z = i[r],
                        (o = Oa(z.data.target, z.event)).id > 0 && ((a = [z.time, z.event]).push(o.id),
                        a.push(z.data.x),
                        a.push(z.data.y),
                        qa(a),
                ...
                case 9:
                    ...
                    c = rn; u < c.length; u++)
                        ...
                        a.push(z.data.trust),
                        qa(a),
                        Ta(z.time, z.event, d, z.data.x, z.data.y, z.data.reaction, z.data.context);
                    dn();
                    break;
                case 38:
                    for (f = 0,
                    h = fn; f < h.length; f++)
                        z = h[f],
                        a = [z.time, z.event],
                        (j = Oa(z.data.target, z.event)).id > 0 && (a.push(j.id),
                ...
                case 10:
                    ...
                    x = In; S < x.length; S++)
                        z = x[S],
                        (M = Oa(z.data.target, z.event)).id > 0 && ((a = [z.time, z.event]).push(M.id),
                        a.push(z.data.x),
                        a.push(z.data.y),
                        qa(a),
                        T(z.event, z.data.x, z.data.y));
                ...
                case 42:
                    ...
                    _ = $e; N < _.length; N++)
                        z = _[N],
                        a = [z.time, z.event],
                        (j = Oa(z.data.target, z.event)).id > 0 && ((a = [z.time, z.event]).push(j.id),
                        a.push(z.data.type),
    ...
    var _a, Ia, Ca, Da, ja, Aa = 0, La = 0, za = null, Ra = 0;
    function Ha() {
        Da = !0,
        Aa = 0,
        La = 0,
    ...
    function Ya(t) {
        ...
        at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(l) {
                ...
                case 0:
                    return za = null,
                    (e = !1 === o.lean && La > 0 && (La < 1048576 || Vr.sequence > 0)) && W(1, 1),
                    Je(),
                    function() {
                        var t = [];
                        Ma = [];
                        for (var e = Vr.start + Vr.duration, n = Math.max(e - 2e3, 0), a = 0, r = xa; a < r.length; a++) {
                            var i = r[a];
                            i.time >= n && (i.time <= e && Ma.push(i),
                            t.push(i))
                        }
                        xa = t,
                        Sa(22)
                ...
                case 2:
                    ...
                    l.label = 3;
                case 3:
                    return q(2, (c = s) ? c.length : u.length),
    ...
    function Pa(t, e) {
        var n = Ca[e];
        t && 4 === t.readyState && n && ((t.status < 200 || t.status > 208) && n.attempts <= 1 ? t.status >= 400 && t.status < 500 ? br(6) : (0 === t.status && (o.upload = o.fallback ? o.fallback : o.upload),
        Xa(n.data, null, e)) : (ja = {
            sequence: e,
            attempts: n.attempts,
            status: t.status
    ...
    function Fa(t) {
        var e = t.error || t;
        return e.message in Va || (Va[e.message] = 0),
        Va[e.message]++ >= 5 || e && e.message && (Ba = {
            message: e.message,
            line: t.lineno,
            column: t.colno,
            stack: e.stack,
    ...
    var Qa, $a = {}, tr = new Set, er = {}, nr = {}, ar = {}, rr = {};
    function ir() {
        sr()
    }
    function or(t) {
            ...
            for (var t in er) {
                ...
                if ("" == rr[e] || document.querySelector(rr[e])) {
                    ...
                    for (var u in o) {
                        ...
                        if (s)
                            lr(e, c, Array.from(s).map((function(t) {
    ...
    function Cr() {
        Ir = null;
        var t, e = navigator && "userAgent"in navigator ? navigator.userAgent : "", n = document && document.title ? document.title : "", a = e.indexOf("Electron") > 0 ? 1 : 0, r = function() {
            var t = {
                session: Wr(),
        ...
        o.upload = o.track && "string" == typeof o.upload && r.upload && r.upload.length > "https://".length ? r.upload : o.upload,
        xr(0, e),
        xr(3, n),
        ...
        W(1, 0),
        W(35, a),
        navigator && (xr(9, navigator.language),
        W(33, navigator.hardwareConcurrency),
        W(32, navigator.maxTouchPoints),
        W(34, Math.round(navigator.deviceMemory)),
        (t = navigator.userAgentData) && t.getHighEntropyValues ? t.getHighEntropyValues(["model", "platform", "platformVersion", "uaFullVersion"]).then((function(t) {
            var e;
            xr(22, t.platform),
    ...
    function Rr() {
        var t = Math.round(Date.now())
          ...
          , n = o.lean ? 0 : 1;
        !function(t) {
            _r.length > 0 && _r.forEach((function(e) {
    ...
    function qr(t, e) {
        ...
        (null === t.expiry || Math.abs(n - t.expiry) >= 1 || t.consent !== e || t.dob !== a) && Ur("_clck", [Tr.userId, 2, n.toString(36), e, a].join("|"), 365)
    }
    function Wr() {
    ...
    function Ur(t, e, n) {
        if (o.track && (navigator && navigator.cookieEnabled || Hr(document, "cookie"))) {
            var a = new Date;
            ...
            try {
                if (null === Ir) {
                    for (var u = location.hostname ? location.hostname.split(".") : [], c = u.length - 1; c >= 0; c--)
                        if (Ir = ".".concat(u[c]).concat(Ir || ""),
                        c < u.length - 1 && (document.cookie = "".concat(i).concat(";").concat("domain=").concat(Ir),
                        Pr(t) === e))
                            return;
                    Ir = ""
                }
            ...
            document.cookie = Ir ? "".concat(i).concat(";").concat("domain=").concat(Ir) : i
        }
    }
    var Br, Vr = null;
    function Fr() {
    ...
    function Gr(t) {
        return Vr.start = Vr.start + Vr.duration,
        Vr.duration = s() - Vr.start,
        Vr.sequence++,
        Vr.upload = t && "sendBeacon"in navigator ? 1 : 0,
        Vr.end = t ? 1 : 0,
        [Vr.version, Vr.sequence, Vr.start, Vr.duration, Vr.projectId, Vr.userId, Vr.sessionId, Vr.pageNum, Vr.upload, Vr.end]
    }
    function Zr() {
        Br = []
    }
    ...
    function di() {
        ...
        null === ni && (ni = history.pushState,
        history.pushState = function() {
            ni.apply(this, arguments),
            hi() && oi() && ui()
        }
        ),
        null === ai && (ai = history.replaceState,
    ...
    var bi = Object.freeze({
        ...
        start: function() {
            ...
            function() {
                ...
                pa = 0,
                va = {},
                null === sa && (sa = CSSStyleSheet.prototype.insertRule,
                CSSStyleSheet.prototype.insertRule = function() {
                    return hi() && wa(this.ownerNode),
                    sa.apply(this, arguments)
                }
                ),
                null === la && (la = CSSStyleSheet.prototype.deleteRule,
                ...
                null === da) {
                    ...
                    try {
                        Element.prototype.attachShadow = function() {
                            return hi() ? wa(da.apply(this, arguments)) : da.apply(this, arguments)
                        }
                    } catch (t) {
                        da = null
                    }
    ...
    var Oi = ["navigation", "resource", "longtask", "first-input", "layout-shift", "largest-contentful-paint"];
    function Si() {
        try {
            yi && yi.disconnect(),
            yi = new PerformanceObserver(Qr(xi));
            for (var t = 0, e = Oi; t < e.length; t++) {
                var n = e[t];
                PerformanceObserver.supportedEntryTypes.indexOf(n) >= 0 && ("layout-shift" === n && q(9, 0),
                yi.observe({
                    type: n,
                    buffered: !0
                }))
    ...
    var Ni = [gi, bi, Zn, Object.freeze({
        __proto__: null,
        start: function() {
            ki(),
            function() {
                navigator && "connection"in navigator && xr(27, navigator.connection.effectiveType),
                window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? ti(window, "load", Y.bind(this, Si, 0)) : Si() : Ka(3, 0)
            }()
        },
        stop: function() {
            yi && yi.disconnect(),
    ...
    function Ti(t) {
        ...
        function() {
            try {
                return !1 === li && "undefined" != typeof Promise && window.MutationObserver && document.createTreeWalker && "now"in Date && "now"in performance && "undefined" != typeof WeakMap
            } catch (t) {
                return !1
            }
        }() && (pi(t),
    ...
    function _i() {
        hi() && (Ni.slice().reverse().forEach((function(t) {
            return Qr(t.stop)()
        }
        )),
        bt(),
        fi(),
        void 0 !== Ci && (Ci[Di] = function() {
            (Ci[Di].q = Ci[Di].q || []).push(arguments),
            "start" === arguments[0] && Ci[Di].q.unshift(Ci[Di].q.pop()) && ji()
        }
        ))
    }
    var Ii = Object.freeze({
        ...
        pause: function() {
            hi() && (A("clarity", "pause"),
            null === le && (le = new Promise((function(t) {
                de = t
            }
            ))))
        },
    ...
    function ji() {
        if (void 0 !== Ci) {
            ...
            var t = Ci[Di] && Ci[Di].q || [];
            for (Ci[Di] = function(t) {
                for (var e = [], n = 1; n < arguments.length; n++)
                    e[n - 1] = arguments[n];
                return Ii[t].apply(Ii, e)
            }
            ,
            Ci[Di].v = l; t.length > 0; )
