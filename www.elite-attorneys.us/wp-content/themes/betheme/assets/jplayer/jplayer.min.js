...
(function(b, f) {
    ...
    k.browser && (b.jPlayer.browser[k.browser] = !0,
    b.jPlayer.browser.version = k.version);
    k = b.jPlayer.uaPlatform(navigator.userAgent);
    k.platform && (b.jPlayer.platform[k.platform] = !0,
    ...
    b.jPlayer.prototype = {
        ...
        _init: function() {
            ...
            b.each(b.jPlayer.event, function(c, b) {
                a.options[c] !== f && (a.element.bind(b + ".jPlayer", a.options[c]),
                a.options[c] = f)
            });
        ...
        _testPlaybackRate: function(a) {
            ...
            try {
                return "playbackRate"in a ? (a.playbackRate = 0.5,
                0.5 === a.playbackRate) : !1
            } catch (c) {
                return !1
            }
        },
        ...
        _addHtmlEventListeners: function(a, c) {
            ...
            this.status.playbackRateEnabled && (a.defaultPlaybackRate = this.options.defaultPlaybackRate,
        ...
        tellOthers: function(a, c) {
            ...
            "string" === typeof a && (e && g.splice(1, 1),
        ...
        _updatePlaybackRate: function() {
            ...
            this.css.jq.playbackRateBarValue[this.options.verticalPlaybackRate ? "height" : "width"](100 * a + "%"))) : (this.css.jq.playbackRateBar.length && this.css.jq.playbackRateBar.hide(),
        ...
        _updateAutohide: function() {
            ...
            this.status.nativeVideoControls ? this.css.jq.gui.hide() : this.options.fullWindow && this.options.autohide.full || !this.options.fullWindow && this.options.autohide.restored ? (this.element.bind("mousemove.jPlayer.jPlayerAutohide", c),
