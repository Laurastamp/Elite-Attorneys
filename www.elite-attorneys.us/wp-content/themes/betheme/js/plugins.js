    ...
    t.fn.twentytwenty = function(e) {
        ...
        return this.each(function() {
            ...
            c.on("move", function(t) {
                i.hasClass("active") && (n = "vertical" === a ? (t.pageY - offsetY) / imgHeight : (t.pageX - p) / y,
                0 > n && (n = 0),
                n > 1 && (n = 1),
                v(n))
            }),
...
!function(t) {
    ...
    function v() {
        L(document, Q.move, f),
        L(document, Q.cancel, s)
    }
    function p(t) {
        var e, n;
        z[t.target.tagName.toLowerCase()] || (e = t.changedTouches[0],
        n = {
            target: e.target,
            startX: e.pageX,
            startY: e.pageY,
    ...
    function R(t, e, n) {
        return K(this, "movestart.move", w),
        !0
    }
    function x(t) {
        return L(this, "dragstart drag", o),
        L(this, "mousedown touchstart", r),
        L(this, "movestart", w),
        !0
    }
    function b(t) {
        "move" !== t.namespace && "moveend" !== t.namespace && (K(this, "dragstart." + t.guid + " drag." + t.guid, o, e, t.selector),
        K(this, "mousedown." + t.guid, r, e, t.selector))
    }
    function j(t) {
        "move" !== t.namespace && "moveend" !== t.namespace && (L(this, "dragstart." + t.guid + " drag." + t.guid),
    ...
    t.event.special.movestart = {
        ...
        _default: function(t) {
            ...
            t.identifier === e ? (K(t.target, "click", i),
            K(document, Q.move, T, r),
            K(document, Q.end, S, r)) : (t._preventTouchmoveDefault(),
    ...
    a.fn.extend({
        BlackAndWhite: function(b) {
            ...
            var c = this
              ...
              , k = a(window)
              , l = ".BlackAndWhite"
              , m = (document.all && !window.opera && window.XMLHttpRequest ? !0 : !1,
            " -webkit- -moz- -o- -ms- ".split(" "))
              ...
              , p = function() {
                ...
                return a.style.cssText = m.join("filter:blur(2px); "),
              ...
              , C = function(b, c) {
                ...
                q && !p ? (d = a('<canvas width="' + e.naturalWidth + '" height="' + e.naturalHeight + '" class="BWfade"></canvas>'),
                i.width = b.width(),
                i.height = b.height(),
                B(e, d.get(0), e.naturalWidth, e.naturalHeight)) : (q ? i[s] = "grayscale(" + 100 * h + "%)" : i.filter = "progid:DXImageTransform.Microsoft.BasicImage(grayscale=1)",
                d = b.clone().addClass("BWFilter BWfade"),
                x(e)),
                d.css(i).prependTo(c),
                !a.support.opacity && g && d.animate({
                    opacity: 0
                }, 0)
            }
              , D = function() {
              ...
              , E = function() {
                ...
                y(b),
                e && c.unbind(l).on("mouseleave" + l, v).on("mouseenter" + l, w),
                q && !p && k.unbind(l).on("resize" + l + " orientationchange" + l, D)
            }
              , F = function() {
                c.off(l),
                k.off(l)
...
!function(e) {
    ...
    var m = window.MutationObserver || window.WebKitMutationObserver || !1
      ...
      , w = function() {
        ...
        n.hasw3ctouch = (window.PointerEvent || !1) && (navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0),
      ...
      , v = function(e, o) {
        ...
        this.debounced = function(e, o, t) {
            var r = v.delaylist[e];
            v.delaylist[e] = o,
            r || (v.debouncedelayed = setTimeout(function() {
                if (v) {
                    var o = v.delaylist[e];
                    v.delaylist[e] = !1,
                    o.call(v)
        ...
        this.init = function() {
            ...
            !v.ispage || !x.cantouch && !x.isieold && !x.isie9mobile) {
                ...
                for (var h in u)
                    ...
                    s ? t.css("padding-" + d, s + "px") : v.opt.railpadding[d] = 0;
                t.append(o),
                ...
                v.rail.drag = !1;
                var p = !1;
                !v.opt.boxzoom || v.ispage || x.isieold || (p = document.createElement("div"),
                ...
                if (v.opt.horizrailenabled) {
                    ...
                    f.height = Math.max(parseFloat(v.opt.cursorwidth), o.outerHeight()),
                    f.css({
                        height: f.height + "px",
                        zIndex: v.zindex,
                        background: v.opt.background
                ...
                v.istextarea && (v.bind(v.win, "keydown", v.lazyResize),
        ...
        this.onResize = function(e, o) {
            ...
            v.cursorheight = 0,
            v.setScrollTop(0),
            v.rail && (v.rail.scrollable = !1)) : (v.page.maxh -= v.opt.railpadding.top + v.opt.railpadding.bottom,
            v.rail.scrollable = !0),
            ...
            v.cursorwidth = 0,
            v.setScrollLeft(0),
            v.railh && (v.railh.scrollable = !1)) : (v.page.maxw -= v.opt.railpadding.left + v.opt.railpadding.right,
            ...
            v.railslocked)
                ...
                !1;
            v.hidden || v.visibility ? !v.railh || v.hidden || v.railh.visibility || v.showRailHr() : v.showRail().showRailHr(),
